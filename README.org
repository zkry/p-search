...
* Usage
  ...
  current directory. Execute =p-search= with the prefix <kbd>C-u</kbd>
...
*** Candidate Generators
    ...
    =p-search-add-candidate-generator= (<kbd>C</kbd>)to add a new candidate generator.

*** Priors

    The Priors section is the part where you add search criteria to
    your session.  Run =p-search-add-prior= to add a prior function.
